...
class DownloadXmlRequest{
    public static function soapRequest($cert, $keyPEM, $token, $rfc,$rfcReceptor, $idPaquete){
        $xmlString = DownloadXmlRequest::getSoapBody($cert, $keyPEM, $rfc,$rfcReceptor, $idPaquete);
    ...
    public static function getSoapBody($cert, $keyPEM, $rfc,$rfcReceptor, $idPaquete){
      ...
      $dataToHash = '<des:PeticionDescargaMasivaTercerosEntrada xmlns:des="http://DescargaMasivaTerceros.sat.gob.mx"><des:peticionDescarga IdPaquete="'.$idPaquete.'" RfcSolicitante="'.$rfcsolicita.'"></des:peticionDescarga></des:PeticionDescargaMasivaTercerosEntrada>';
