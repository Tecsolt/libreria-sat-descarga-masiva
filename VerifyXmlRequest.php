...
{
    public static function soapRequest($cert, $keyPEM, $token, $rfc, $rfcReceptor, $idSolicitud)
    {
        $xmlString = VerifyXmlRequest::getSoapBody($cert, $keyPEM, $rfc, $rfcReceptor, $idSolicitud);
    ...
    public static function getSoapBody($cert, $keyPEM, $rfc,$rfcReceptor, $idSolicitud)
    {
        ...
        $dataToHash = '<des:VerificaSolicitudDescarga xmlns:des="http://DescargaMasivaTerceros.sat.gob.mx"><des:solicitud IdSolicitud="' . $idSolicitud . '" RfcSolicitante="' . $rfcsolicita . '"></des:solicitud></des:VerificaSolicitudDescarga>';
